Veewee::Session.declare({
  ...
  :disk_size => '20140', :disk_format => 'VDI', :hostiocache => 'off', :hwvirtext => 'on',
  :os_type_id => 'Fedora',
  ...
  :postinstall_files => [ "postinstall.sh", "postinstall_obslight.sh"], :postinstall_timeout => 10000
})
