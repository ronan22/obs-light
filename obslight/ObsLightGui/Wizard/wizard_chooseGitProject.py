...
# Form implementation generated from reading ui file 'ui/wizard_chooseGitProject.ui'
#
...
class Ui_WizardPage(object):
    def setupUi(self, WizardPage):
        ...
        self.gridLayout.addWidget(self.gitProjectTreeView, 0, 0, 1, 5)
        self.selectAllPushButton = QtGui.QPushButton(WizardPage)
        self.selectAllPushButton.setObjectName("selectAllPushButton")
        self.gridLayout.addWidget(self.selectAllPushButton, 1, 2, 1, 1)
        self.unselectAllPushButton = QtGui.QPushButton(WizardPage)
        self.unselectAllPushButton.setObjectName("unselectAllPushButton")
        self.gridLayout.addWidget(self.unselectAllPushButton, 1, 3, 1, 1)
        self.importPushButton = QtGui.QPushButton(WizardPage)
        self.importPushButton.setObjectName("importPushButton")
        self.gridLayout.addWidget(self.importPushButton, 1, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.loadManifestPushButton, 1, 1, 1, 1)
    ...
    def retranslateUi(self, WizardPage):
        ...
        self.importPushButton.setText(QtGui.QApplication.translate("WizardPage", "Import", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.loadManifestPushButton.setText(QtGui.QApplication.translate("WizardPage", "Load Manifest", None, QtGui.QApplication.UnicodeUTF8))
